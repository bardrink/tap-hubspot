...
class ContactStream(DynamicHubspotStream):
    ...
    def get_url_params(
        ...
        params["associations"] = "companies,deals,task,call,email,meeting"  # get associated objects
        return params
...
class DealStream(DynamicHubspotStream):
    ...
    def get_url_params(
        ...
        params = super().get_url_params(context, next_page_token)
        params["archived"] = context["archived"]
        params["associations"] = "companies,line_item,task,call,email,meeting,contact"  # get associated objects
        return params
